...
# make sure to save from GRCh38 and not 37
###############################################################################
...
ggsave("lollipop_ClinVar_CHD3_Pfam_labeled.png", plot_lollipop, width = 12, height = 4.5, dpi = 300)
message("✅ Lollipop plot with Pfam domain names saved as: lollipop_ClinVar_CHD3_Pfam_labeled.png")
