...
###############################################################################
# 1) Load and filter ClinVar missense variants for GABRG2
###############################################################################
...
###############################################################################
# 2) Load Pfam domain annotations for GABRG2
###############################################################################
...
plot_lollipop <- ggplot() +
  ...
  ggtitle("Pathogenic Missense Variants in GABRG2 (Pfam Domains + Canonical Exons)") +
  custom_theme
...
ggsave("lollipop_ClinVar_GABRG2_Pfam_and_Exons.png", plot_lollipop, width = 12, height = 5, dpi = 300)
message("✅ Saved as: lollipop_ClinVar_GABRG2_Pfam_and_Exons.png")
