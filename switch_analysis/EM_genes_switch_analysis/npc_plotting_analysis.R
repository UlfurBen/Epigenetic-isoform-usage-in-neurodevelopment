...
###############################################################
# Script 2: Plotting Isoform Expression (Top Significant)
###############################################################
...
# Plot
pdf("top_significant_isoform_expression_plots_with_npc.pdf", width = 12, height = 8)
p <- ggplot(plot_data, aes(x = Day, y = Mean_Expression, fill = Day)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Top Significantly Upregulated Isoforms (incl. NPC)",
