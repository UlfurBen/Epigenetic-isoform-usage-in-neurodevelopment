...
# Create both plots
p1 <- create_plot(plot_data_incl_npc, "Top 10 Significant Isoforms (NPC Highest Expression, Whole Genome)")
p2 <- create_plot(plot_data_excl_npc, "Top 10 Significant Isoforms (Day3/6/12 Highest Expression, Whole Genome)")
